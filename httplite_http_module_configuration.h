...
char* httplite_core_server(ngx_conf_t *configuration, ngx_command_t *command, void *dummy);
void* httplite_core_create_server_configuration(ngx_conf_t *configuration);
